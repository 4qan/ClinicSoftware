...
- [x] **URDU-06**: Rx Notes field has English/Urdu toggle that switches text direction and font
- [x] **URDU-07**: Rx Notes print in the language they were written in (correct direction and font)
